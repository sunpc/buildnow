 ...
 *  08. 12/11/2018: Add stringToHexString() and hexStringToString() methods. (zDevOps v1.0)
 */
...
public class TextProcessor {
	...
	public static String replaceStr(String inputStr, String oldString, String newString) throws IOException {
		if (inputStr == null) {
			return null;
		}
	...
	public static void generateJcl(String outputFileName, String[][] globalParam, String... jclParts) throws Exception {
		// merge the JCL parts
		String jcl = "";
