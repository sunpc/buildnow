<template>
  <div class="vqb-rule" :class="{ 'panel panel-default form-inline': styled }">
    <div :class="{ 'form-group': styled }">
      ...
      <input :class="{ 'form-control': styled }" v-if="rule.inputType === 'text' && query.selectedOperator!='is empty' && query.selectedOperator!='is not empty'" type="text" v-model="query.value" :placeholder="labels.textInputPlaceholder">
